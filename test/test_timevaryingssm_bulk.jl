# test/test_timevaryingssm_bulk.jl
#
...
@testset "TimeVaryingSSM reduces exactly to GaussianSSM -- full 364-case regression suite" begin
    ...
    let ar = [0.3], ma = Float64[], sar = Float64[], sma = Float64[], s = 0
        ...
        if converged
            tv, a0, P0 = TSAnalytics.to_time_varying(ssm, y_ar1_shared)
            loglik_tv, v_tv, F_tv, converged_tv = TSAnalytics.kalman_filter(tv, y_ar1_shared, a0, P0)
            @test converged_tv
    ...
    let ar = [0.3], ma = Float64[], sar = Float64[], sma = Float64[], s = 0
        ...
        if converged
            tv, a0, P0 = TSAnalytics.to_time_varying(ssm, y_ar2_shared)
            loglik_tv, v_tv, F_tv, converged_tv = TSAnalytics.kalman_filter(tv, y_ar2_shared, a0, P0)
            @test converged_tv
            @test isapprox(loglik_tv, loglik; atol=1e-8)
            @test isapprox(v_tv, v; atol=1e-8)
        end
    ...
    let ar = [0.3], ma = Float64[], sar = Float64[], sma = Float64[], s = 0
        ...
        if converged
            tv, a0, P0 = TSAnalytics.to_time_varying(ssm, y_ma1_shared)
            loglik_tv, v_tv, F_tv, converged_tv = TSAnalytics.kalman_filter(tv, y_ma1_shared, a0, P0)
            @test converged_tv
            @test isapprox(loglik_tv, loglik; atol=1e-8)
            @test isapprox(v_tv, v; atol=1e-8)
        end
    ...
    let ar = [0.3], ma = Float64[], sar = Float64[], sma = Float64[], s = 0
        ...
        if converged
            tv, a0, P0 = TSAnalytics.to_time_varying(ssm, y_nile)
            loglik_tv, v_tv, F_tv, converged_tv = TSAnalytics.kalman_filter(tv, y_nile, a0, P0)
            @test converged_tv
            @test isapprox(loglik_tv, loglik; atol=1e-8)
            @test isapprox(v_tv, v; atol=1e-8)
        end
    ...
    let ar = [0.3], ma = Float64[], sar = Float64[], sma = Float64[], s = 0
        ...
        if converged
            tv, a0, P0 = TSAnalytics.to_time_varying(ssm, y_sunspots)
            loglik_tv, v_tv, F_tv, converged_tv = TSAnalytics.kalman_filter(tv, y_sunspots, a0, P0)
            @test converged_tv
            @test isapprox(loglik_tv, loglik; atol=1e-8)
            @test isapprox(v_tv, v; atol=1e-8)
        end
    ...
    let ar = [0.3], ma = Float64[], sar = Float64[], sma = Float64[], s = 0
        ...
        if converged
            tv, a0, P0 = TSAnalytics.to_time_varying(ssm, y_macro_gdp_growth)
            loglik_tv, v_tv, F_tv, converged_tv = TSAnalytics.kalman_filter(tv, y_macro_gdp_growth, a0, P0)
            @test converged_tv
            @test isapprox(loglik_tv, loglik; atol=1e-8)
            @test isapprox(v_tv, v; atol=1e-8)
        end
    ...
    let ar = [0.3], ma = Float64[], sar = Float64[], sma = Float64[], s = 0
        ...
        if converged
            tv, a0, P0 = TSAnalytics.to_time_varying(ssm, y_elnino_monthly)
            loglik_tv, v_tv, F_tv, converged_tv = TSAnalytics.kalman_filter(tv, y_elnino_monthly, a0, P0)
            @test converged_tv
            @test isapprox(loglik_tv, loglik; atol=1e-8)
            @test isapprox(v_tv, v; atol=1e-8)
        end
    ...
    let ar = [0.3], ma = Float64[], sar = Float64[], sma = Float64[], s = 0
        ...
        if converged
            tv, a0, P0 = TSAnalytics.to_time_varying(ssm, y_co2_diff)
            loglik_tv, v_tv, F_tv, converged_tv = TSAnalytics.kalman_filter(tv, y_co2_diff, a0, P0)
            @test converged_tv
            @test isapprox(loglik_tv, loglik; atol=1e-8)
            @test isapprox(v_tv, v; atol=1e-8)
        end
